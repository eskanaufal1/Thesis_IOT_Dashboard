    ...
    <div className="animate-fade-in">
      ...
      >
        <div className="space-y-4">
          ...
          >
            <option value="Offline" className="text-slate-900 dark:text-slate-50 bg-white dark:bg-slate-950">Offline</option>
          ...
          {[1, 2, 3, 4].map((relayNum) => (
            <select
              ...
              className="flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 ring-offset-white placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50 dark:ring-offset-slate-950 dark:placeholder:text-slate-400 dark:focus-visible:ring-slate-300"
            >
              <option value="Off" className="text-slate-900 dark:text-slate-50 bg-white dark:bg-slate-950">Relay {relayNum} - Off</option>
              <option value="On" className="text-slate-900 dark:text-slate-50 bg-white dark:bg-slate-950">Relay {relayNum} - On</option>
            </select>
          ))}
        </div>
      </Modal>
